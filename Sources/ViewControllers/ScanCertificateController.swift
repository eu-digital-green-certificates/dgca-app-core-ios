...
// HC1:6BFOXN%TSMAHN-HQRC4XU6/TBYDQ6N/R8YRU2FCRI9$06P-O1-IJ4T4:OQ$S2*C/GPWBI$C9UDBQEAJJKKKMEC8ZI9$JAQJKKIJX2MM+GWHKSKE MCAOI8%M1-Q4-RVNI3-SY$N8%Q25C942I%KY*N$FKV$K0MKFW04+OT.TC.U$PI*44T15QAKTJ39190EU1RM8ZAUZ4+FJE 4Y3LL/II 0OC9JU0D0HT0HB2PR788FFA.D90I/EL6KKYHIL4OTJLGY8/.DV2MGDIK3MXGG HG4HGBIK6IA*$30JAXD16IASD9M82+00UTKN9CJZI-.1UEEZ.C*HJG.CZ.C4C96+KA0G6LG9KDG+9L0H7D0K$4ZTM3AN7755QLQQ5DVQ8NP975-*O:F6 /6-MPBK8L*OJ%RZCRNDO4GBVIRJE4JJQ*55V0J0CF2C4WKOR-C4 USRJ1PDO-EPDS.L29.6:3E-RHR.VSC7UHANVA+MV68G7:63LL45BU0POZ4AGU$16KZVQOTR8M%:H5/FYJM3PNRXRWBICJ4A00H$1$3
  ...
  func observationHandler(payloadS: String?) {
    if var hCert = HCert(from: payloadS ?? "", applicationType: applicationType) {
      ...
      delegate?.scanController(self, didScanCertificate: hCert)
        ...
        print("Error when validating the certificate?  \(payloadS)")
        delegate?.scanController(self, didFailWithError: CertificateParsingError.parsing)
    }
  }
}
