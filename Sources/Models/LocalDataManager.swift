...
public class LocalDataManager {
  private let pubKeysStorageFilename = "secure"
    
  public var localData: LocalData = LocalData()
  lazy var storage = SecureStorage<LocalData>(fileName: pubKeysStorageFilename)
